...
class TestProfilePage(StaticLiveServerTestCase):
    ...
    def test_profile(self):
        ...
        time.sleep(2)
        self.assertEquals(title.text, "Profile")

    def test_profile_navigation_to_posts(self):
        time.sleep(2)
    ...
    def test_profile_navigation_to_add_post(self):
        time.sleep(2)
    ...
    def test_profile_navigation_to_block_users_page(self):
        time.sleep(2)
